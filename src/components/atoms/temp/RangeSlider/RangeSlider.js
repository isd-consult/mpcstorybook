...
class RangeSlider extends Component {
  ...
  initSlider() {
    ...
    const { items, isVertical, onChange, value, name } = this.props
  ...
  render() {
    ...
    return (
      <div className={clsx(
        'range-slider',
        {[`range-slider--${category}`]: category}, 
        className
      )}
      >
        <div className="range-slider__body" ref={this.$slider} />
      </div>
    )
  }
}
...
RangeSlider.propTypes = {
  ...
  value: PropTypes.any,
  category: PropTypes.oneOf([null, "secondary", "tertiary"])
}
